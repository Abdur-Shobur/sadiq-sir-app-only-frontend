							...
							<div class="col-lg-4">
								<div class="column md-mb50">
									...
									<h6 class="p-color fw-400">
										{{ $profileData->address ?? '5919 Trussville Crossings Pkwy, Birmingham' }}
									</h6>
									<h6 class="mt-30 mb-15">
										<a href="mailto:{{ $profileData->email ?? 'Hello@webfolio.com' }}">{{ $profileData->email ?? 'Hello@webfolio.com' }}</a>
									</h6>
									<a href="tel:{{ $profileData->phone ?? '+2 456 (343) 24 45' }}" class="underline">
										<span class="fz-22 main-color">{{ $profileData->phone ?? '+2 456 (343) 24 45' }}</span>
									</a>
								</div>
							</div>
							<div class="col-lg-2">
